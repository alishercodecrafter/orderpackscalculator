...
//// calculatePacks is a helper function to calculate the optimal number of packs needed for an order
//func (s *PacksServiceImpl) calculatePacks(orderSize int, packsRule2, packsRule3 map[int]int, sortedPackSizes *[]int) int {
//	if orderSize == 0 {
//		amountByRule2 := getAmountOfItemsInPacks(packsRule2)
//		amountByRule3 := getAmountOfItemsInPacks(packsRule3)
//
//		if amountByRule2 < amountByRule3 {
//			return 0
//		}
//
//		return 1
...
//		orderSize = 0
//		packsRule2[packSize]++
//		packsRule3[(*sortedPackSizes)[selectedPackSizeIndex+1]]++
//	} else {
//		orderSize -= count * packSize
//		packsRule2[packSize] += count
//		packsRule3[(*sortedPackSizes)[selectedPackSizeIndex+1]]++
//	}
//
//	return s.calculatePacks(orderSize, packsRule2, packsRule3, sortedPackSizes)
//
//	//Create a table for dynamic programming solution
//	//dp[i] will store the minimum number of packs needed for orderSize i
//	//packChoice[i] will store which pack size to use for orderSize i
//
//	//dp := make([]int, orderSize+1)
//	//packChoice := make([]int, orderSize+1)
//	//// Initialize with a value larger than any possible solution
//	//for i := 1; i <= orderSize; i++ {
//	//	dp[i] = orderSize + 1 // A value larger than any possible solution
//	//}
//	//dp[0] = 0
//	//
//	//// Fill dp table
...
//	//if dp[orderSize] > orderSize {
//	//	// Find the smallest pack that exceeds orderSize
//	//	smallestLargerPack := (*sortedPackSizes)[len(*sortedPackSizes)-1]
//	//	for _, size := range *sortedPackSizes {
//	//		if size >= orderSize {
//	//			smallestLargerPack = size
//	//			break
//	//		}
//	//	}
//	//	packs[smallestLargerPack]++
//	//	return
//	//}
//	//
